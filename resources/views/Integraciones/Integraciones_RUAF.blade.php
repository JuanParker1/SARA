<div flex layout=column class="padding bg-black-3" md-theme="Black" 
	ng-controller="Integraciones_RUAFCtrl">

	<div class="md-title text-thin">Sincronización con RUAF</div>
	...
	<div flex layout layout-align="center center">
		...
		<div layout=column layout-align="center center" style="background: #00000029"
			...
			<div class="md-title text-thin lh20 text-center" style="transform: translateY(-40px);">Nacidos Vivos</div>
		</div>
