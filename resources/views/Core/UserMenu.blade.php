<md-menu md-position-mode="target-right target">
	...
	<div class="Pointer h100p" layout layout-align="center center" ng-click="$mdMenu.open($event)">
		<div class="s25 bg-lightgrey border-rounded margin-right-5 border" 
			sstyle="background-image: url({{ 'http://sec.comfamiliar.com/images/fotosEmpleados/' + Usuario.Cedula + '.jpg' }}); background-size: cover; background-position: top center;"></div>
